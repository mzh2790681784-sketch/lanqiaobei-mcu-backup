			...
			if(P3 != 0x0f) //有按键按下
			{
				...
				switch(hang){
					case 1:{P3 = 0xf0; P42 = 1; P44 = 1;
						 ...
						 if(P42 == 0) {key_value=1;key_state=2;}
						 if(P35 == 0) {key_value=2;key_state=2;}
						 if(P34 == 0) {key_value=3;key_state=2;}
					}break;
					case 2:{P3 = 0xf0; P42 = 1; P44 = 1;
						 if(P44 == 0) {key_value=4;key_state=2;}
						 if(P42 == 0) {key_value=5;key_state=2;}
						 if(P35 == 0) {key_value=6;key_state=2;}
						 if(P34 == 0) {key_value=7;key_state=2;}
					}break;
					case 3:{P3 = 0xf0; P42 = 1; P44 = 1;
						 if(P44 == 0) {key_value=8;key_state=2;}
						 if(P42 == 0) {key_value=9;key_state=2;}
						 if(P35 == 0) {key_value=10;key_state=2;}
						 if(P34 == 0) {key_value=11;key_state=2;}
					}break;
					case 4:{P3 = 0xf0; P42 = 1; P44 = 1;
						 if(P44 == 0) {key_value=12;key_state=2;}
						 if(P42 == 0) {key_value=13;key_state=2;}
						 if(P35 == 0) {key_value=14;key_state=2;}
						 if(P34 == 0) {key_value=15;key_state=2;}
					}break;
				}	
			}
